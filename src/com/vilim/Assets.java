...
//    public static BufferedImage[] trees;
    ...
    public static void init() {
        SpriteSheet tilesSheet = new SpriteSheet(ImageLoader.loadImage("res/textures/picture4.png"));
        SpriteSheet playerSheet = new SpriteSheet(ImageLoader.loadImage("res/textures/picture12.png"));
        SpriteSheet entitySheet = new SpriteSheet(ImageLoader.loadImage("res/textures/picture14.png"));
        SpriteSheet iconSheet = new SpriteSheet((ImageLoader.loadImage("res/textures/picture16.png")));
...
//            trees[i] = entitySheet.crop(61 + 100 * i,115, 60, 70);
        ...
        inventory = ImageLoader.loadImage("res/textures/picture20.png");
